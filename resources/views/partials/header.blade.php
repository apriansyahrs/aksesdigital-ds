            ...
            <div class="d-flex align-items-center justify-content-between flex-lg-grow-1">
                ...
                <div class="d-flex align-items-center" id="kt_docs_header_title">
                    ...
                    <div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark my-1 fs-4">Documentation</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-6 my-1">
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-gray-600">Index</li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <div data-kt-search-element="results" class="d-none">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation//index.html" data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Introduction
                                                &amp; Getting Started</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/index.html"
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/build/gulp.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Gulp</span>
                                            <span class="fw-semibold fs-base text-muted">Automate
                                                &amp; enhance your build workflow</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/build/webpack.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Webpack</span>
                                            <span class="fw-semibold fs-base text-muted">Module
                                                bundler for build process automation</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/multi-demo.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Multi-demo</span>
                                            <span class="fw-semibold fs-base text-muted">Multi-demo
                                                concept &amp; usage</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/file-structure.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">File Structure</span>
                                            <span class="fw-semibold fs-base text-muted">Theme File
                                                Structure Organization</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/customization/sass.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">SASS</span>
                                            <span class="fw-semibold fs-base text-muted">SASS
                                                Structure &amp; Customization</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/customization/javascript.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Javacript</span>
                                            <span class="fw-semibold fs-base text-muted">Javacript
                                                Structure &amp; Customization</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/customization/no-jquery.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">No jQuery</span>
                                            <span class="fw-semibold fs-base text-muted">Remove jQuery
                                                from build</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/dark-mode.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/illustrations.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/video-tutorials.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Illustrations</span>
                                            <span class="fw-semibold fs-base text-muted">Youtube video
                                                tutorials</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/rtl.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/integration/blazor.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Blazor</span>
                                            <span class="fw-semibold fs-base text-muted">Bootstrap
                                                Blazor Server Side Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/updates.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/references.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/helpers/flex-layouts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/helpers/text.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/helpers/background.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/helpers/borders.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/helpers/opacity.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/forms/controls.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/forms/checks-radios.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/forms/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/forms/input-group.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/forms/floating-labels.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/buttons.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/indicator.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/rotate.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/tables.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/cards.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/symbol.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Symbol</span>
                                            <span class="fw-semibold fs-base text-muted">Custom
                                                Bootstrap Symbol Component For Avatars and Images</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/badges.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/pulse.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/bullets.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/accordion.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/carousel.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/overlay.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/separator.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/underline.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/tabs.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/breadcrumb.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/modal.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/tooltips.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/popovers.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/pagination.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/rating.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/ribbon.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/alerts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/base/toasts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/autosize.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/select2.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Select2</span>
                                            <span class="fw-semibold fs-base text-muted">Select2 and
                                                Bootstrap Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/clipboard.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/flatpickr.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Flatpickr</span>
                                            <span class="fw-semibold fs-base text-muted">Flatpickr and
                                                Bootstrap Integration for Bootstrap Datepicker and
                                                Timepicker</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formrepeater/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Form Repeater
                                                Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Form Repeater
                                                and Bootstrap Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formrepeater/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formrepeater/nested.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Nested Example</span>
                                            <span class="fw-semibold fs-base text-muted">Form Repeater
                                                Nested Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formrepeater/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Nested Example</span>
                                            <span class="fw-semibold fs-base text-muted">Form Repeater
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formvalidation/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formvalidation/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic Example</span>
                                            <span class="fw-semibold fs-base text-muted">FormValidation
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/formvalidation/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/daterangepicker.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/tagify.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/dialer.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/nouislider.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/password-meter.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/inputmask.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/bootstrap-multiselectsplitter.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/bootstrap-select.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/google-recaptcha.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/dropzonejs.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/image-input.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Image Input</span>
                                            <span class="fw-semibold fs-base text-muted">KTImageInput
                                                Custom Bootstrap Image Input Component with Thumbnail
                                                Preview</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/forms/bootstrap-maxlength.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Bootstrap Maxlength</span>
                                            <span class="fw-semibold fs-base text-muted">A visual
                                                feedback indicator for the maxlength attribute.</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/amcharts/charts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/amcharts/maps.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">AmCharts</span>
                                            <span class="fw-semibold fs-base text-muted">AmCharts Maps
                                                &amp; Bootstrap Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/amcharts/stock-charts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">AmCharts</span>
                                            <span class="fw-semibold fs-base text-muted">AmCharts
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/apexcharts.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/chartjs.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Overview</span>
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/axis.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/tracking.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/dynamic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/stack.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/bar.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/flotcharts/pie.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/google-charts/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Google Charts
                                                Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/google-charts/column.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Column Chart</span>
                                            <span class="fw-semibold fs-base text-muted">Google Column
                                                Charts Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/google-charts/pie.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Pie Chart</span>
                                            <span class="fw-semibold fs-base text-muted">Google Pie
                                                Charts Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/charts/google-charts/line.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Line Chart</span>
                                            <span class="fw-semibold fs-base text-muted">Google Line
                                                Charts Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/tinymce/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/tinymce/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic TinyMCE</span>
                                            <span class="fw-semibold fs-base text-muted">Tinymce Basic
                                                Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/tinymce/plugins.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/tinymce/hidden.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">TinyMCE Menubar</span>
                                            <span class="fw-semibold fs-base text-muted">TinyMCE with
                                                Hidden Menubar Example</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Overview</span>
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/classic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/inline.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/balloon.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/balloon-block.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/ckeditor/document.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/quill/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/quill/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Quill Basic</span>
                                            <span class="fw-semibold fs-base text-muted">Quill Basic
                                                Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/editors/quill/autosave.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">DataTables</span>
                                            <span class="fw-semibold fs-base text-muted">DataTables
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/buttons/export.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/buttons/column-visibility.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">DataTables Column
                                                Visibility</span>
                                            <span class="fw-semibold fs-base text-muted">DataTables
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/server-side.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">DataTables</span>
                                            <span class="fw-semibold fs-base text-muted">DataTables
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/subtable.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/datatables/api.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">API</span>
                                            <span class="fw-semibold fs-base text-muted">DataTables
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/draggable/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Draggable Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Draggable and
                                                Bootstrap Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/draggable/cards.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/draggable/multiple-containers.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/draggable/swappable.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/draggable/restricted.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fslightbox.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/drag-n-drop.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/selectable.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/background-events.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/locales.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/fullcalendar/timezone.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic</span>
                                            <span class="fw-semibold fs-base text-muted">jKanban Basic
                                                Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/color.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/restricted.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Restricted</span>
                                            <span class="fw-semibold fs-base text-muted">jKanban
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/rich.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Rich Content</span>
                                            <span class="fw-semibold fs-base text-muted">jKanban Rich
                                                Content Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jkanban/fixed-height.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/menu/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Menu Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Customm
                                                Bootstrap KTMenu component with Nested Dropdown &amp;
                                                Accordion Submenu</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/menu/customization.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/menu/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/menu/api.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/typedjs.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/stepper.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/scroll.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/cookie.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Cookie</span>
                                            <span class="fw-semibold fs-base text-muted">Custom Cookie
                                                Component</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/cookiealert.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Cookie Alert</span>
                                            <span class="fw-semibold fs-base text-muted">Cookie Alert
                                                Component</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/cropper.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/drawer.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/toastr.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/blockui.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/scrolltop.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/search.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/smooth-scroll.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Smooth Scroll</span>
                                            <span class="fw-semibold fs-base text-muted">Smooth Scroll
                                                and Bootstrap Integration</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/sticky.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/swapper.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/sweetalert.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/toggle.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Overview</span>
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic</span>
                                            <span class="fw-semibold fs-base text-muted">Vis-timeline
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/style.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/group.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/interaction.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/vis-timeline/template.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic</span>
                                            <span class="fw-semibold fs-base text-muted">jsTree Basic
                                                Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/contextual.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/customicons.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Custom Icons</span>
                                            <span class="fw-semibold fs-base text-muted">jsTree Custom
                                                Icons Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/dragdrop.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Drag &amp; Drop</span>
                                            <span class="fw-semibold fs-base text-muted">jsTree Drag
                                                &amp; Drop Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/checkable.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/jstree/ajax.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Ajax Data</span>
                                            <span class="fw-semibold fs-base text-muted">jsTree Ajax
                                                Data Examples</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/tiny-slider/overview.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Tiny Slider
                                                Overview</span>
                                            <span class="fw-semibold fs-base text-muted">Tiny slider
                                                for all purposes</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/tiny-slider/basic.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Basic</span>
                                            <span class="fw-semibold fs-base text-muted">Tiny Slider
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/tiny-slider/advanced.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Custom Navs</span>
                                            <span class="fw-semibold fs-base text-muted">Tiny Slider
                                                Custom Navigation Example</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/general/countup.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/icons/duotune.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/icons/bootstrap-icons.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/icons/custom-icons.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Custom Icons</span>
                                            <span class="fw-semibold fs-base text-muted">Custom Font
                                                Icons</span>
                                        </a>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/icons/font-awesome.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/icons/line-awesome.html"
                                            data-kt-searchable="true"
                                            class="d-none d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Line Awesome</span>
                                            <span class="fw-semibold fs-base text-muted">Line Awesome
                                                Icons and Flaticon Integration</span>
                                        </a>
                                        <!--end::Item-->
                                    </div>
                                ...
                                <div class="mb-0" data-kt-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        <!--begin::Item-->
                                        <a href="../../demo1/dist/documentation/getting-started/dark-mode.html"
                                            class="d-flex flex-column text-dark text-hover-primary py-2">
                                            <span class="fw-bold fs-5 mb-0">Dark Mode</span>
                                            <span class="fw-semibold fs-base text-muted">Dark Mode
                                                Setup for Layout &amp; Components</span>
                                        </a>
