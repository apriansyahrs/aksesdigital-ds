            ...
            <div class="card card-docs flex-row-fluid mb-2">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="pb-10">
                        ...
                        <!--end::Heading-->
                        <!--begin::Block-->
                        <div class="py-5">Separator adalah komponen khusus untuk digunakan pada blok halaman perangkat
                            dengan ruang dan garis visual.</div>
                        <!--end::Block-->
                    </div>
                    <!--end::Section-->
                    <!--begin::Section-->
                    ...
                    <div class="py-10">
                        ...
                        <div class="py-5">
                            ...
                            <div class="highlight">
                                ...
                                <div class="highlight-code">
                                    <pre class="language-html">
<code class="language-html">&lt;div class="separator separator-dotted border-success my-10"&gt;&lt;/div&gt;

&lt;div class="separator separator-dashed border-primary my-10"&gt;&lt;/div&gt;</code>
</pre>
                                </div>
                            </div>
                            <!--end::Highlight-->
